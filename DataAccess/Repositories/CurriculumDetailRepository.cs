...
namespace DataAccess.Repositories
{
    public class CurriculumDetailRepository : BaseRespository<CurriculumDetail, CurriculumDetailDTO>, ICurriculumDetailRepository
    {
        ...
        {
            CurriculumDetail basic = _context.CurriculumDetails.Include(x => x.Subject).Include("GradeGenerals.Assessment.Category").Include(x => x.Curriculum).FirstOrDefault(x => x.Id == id);
